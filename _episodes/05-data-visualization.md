...
~~~
Error in ggplot(data = metadata, aes(x = sample, y = generation)): object 'metadata' not found
~~~
{: .error}
...
>> 
>> ~~~
>> Error in ggplot(data = metadata, aes(x = strain, y = genome_size)): object 'metadata' not found
>> ~~~
>> {: .error}
> {: .solution}
{: .challenge}
...
~~~
Error in eval(lhs, parent, parent): object 'metadata' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = sample_per_generation, aes(x = generation, y = n)): object 'sample_per_generation' not found
~~~
{: .error}
